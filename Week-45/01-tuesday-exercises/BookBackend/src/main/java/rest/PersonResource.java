...
//        all.put("all", persons);
    ...
    @GET
    @Produces({MediaType.APPLICATION_JSON})
    public String getPersonDTObyID(@PathParam("id") int id) throws BookNotFoundException {
        try {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response editPerson(String p) throws BookNotFoundException {
        try {
            PersonDTO personDTO = GSON.fromJson(p, PersonDTO.class);
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Path("{id}")
    public String deletePerson(@PathParam("id") int id) throws BookNotFoundException {
        try {
